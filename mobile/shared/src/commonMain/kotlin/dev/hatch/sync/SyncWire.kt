...
// Kotlin transcription of Services/SyncWire.cs + the payload schema in
// docs/sync-protocol.md §4. PascalCase names, enums as ints, nulls written,
// unknown properties ignored (older writers emitted derived fields).
//
// Timestamps stay as String deliberately: the contract pins the wire text, and parsing to
// a date type would risk re-formatting it on the way back out. Clients parse them at the
// edges, not in the wire model.
